...
2. user 레코드 생성
   ...
   VALUES(102, '국현', '전', 100,'발리', '010-1234-1234',90000000);
   ```
...
5. 나이가 30이면서 성이 김씨인 사람의 인원 수
   ...
   ### or조건을 사용하고 싶을 때는 Q obejct를 활용합니다.
...
6. 나이가 30이거나 성이 김씨인 사람?
   ...
   from django.db.models import Q
   User.objects.filter(
      Q(age=30) | Q(last_name='김')).values('first_name')
...
1. 나이가 많은 사람순으로 10명
      ...
      ```python
   # orm
   User.objects.order_by('-age')[0:10].values('first_name')
   ```
